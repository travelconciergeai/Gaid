...
const App = () => {
  ...
  // Login + onboarding are temporarily disabled — the app boots straight into Home.
  // (Components LoginDesktop/OnboardingDesktop remain available to re-enable later.)
  // if (!acct.authed) {
